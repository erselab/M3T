...
#' sewer systems.
#'
#' @format ## `Total_national_open_or_low_int_area` A list with 14 entries named
#'   by year, each with numeric values representing the total of this land cover
#'   for the year across CONUS.
...
#' #' The wastewater flow from municipal wastewater treatment facilities across the
#' #' United States
#' #'
#' #' Wastewater flow rates in millions of gallons per day
#' #'
#' #' Discharge monitoring report (DMR) data on flow and location for municipal
#' #' wastewater treatment plants in the US.
#' #'
#' #' @format ## `DMR_data` A data frame with 222,661 rows and 6 columns:
#' #' \describe{
#' #'   \item{Facility_Name}{Facility name}
#' #'   \item{State}{State the facility is in}
#' #'   \item{Facility_Latitude}{Facility location coordinates}
#' #'   \item{Facility_Longitude}{Facility location coordinates}
#' #'   \item{Average_Daily_Flow__MGD_}{Annual flow of municipal wastewater through a facility in millions of gallons per day}
#' #'   \item{year}{Year of data}
#' #' }
#' #' @source <https://echo.epa.gov/trends/loading-tool/water-pollution-search>
#' 'DMR_data'
...
#' #' A subset of data from the GHGRP
#' #'
#' #' Data for all facilities with GHGRP data
#' #'
#' #' @format ## `GHGRP_facility_data` A data frame with 136,005 rows, and 6 columns:
#' #' \describe{
#' #'   \item{facility_id}{Unique GHGRP ID for each facility}
#' #'   \item{facility_name}{Name of facility}
#' #'   \item{latitude}{Facility location coordinates}
...
#' #' }
#' #' @source
#' #' <https://enviro.epa.gov/envirofacts/metadata/table/ghg/pub_dim_facility>
#' 'GHGRP_facility_data'
...
#' #' A subset of data from the GHGRP
#' #'
#' #' Data for petroleum and natural gas systems
#' #'
#' #' @format ## `GHGRP_subpartW_emissions` A data frame with 503,060 rows, and 5 columns:
#' #' \describe{
#' #'   \item{facility_id}{Unique GHGRP ID for each facility}
#' #'   \item{facility_name}{Name of facility}
#' #'   \item{industry_segment}{Segment of the industry the facility operates under (e.g., onshore natural gas processing, onshore petroleum and natrual gas production)}
#' #'   \item{reporting_year}{Year of data}
#' #'   \item{total_reported_ch4_emissions}{emissions of methane in metric tons of methane per year}
#' #' }
#' #' @source
#' #' <https://enviro.epa.gov/envirofacts/metadata/table/ghg/ef_w_emissions_source_ghg>
