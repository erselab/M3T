...
main_config <- function(){
  ...
  #defaults to 1 minute, adjust that to 5 minutes just in case of a slow
  #internet speed.  It will revert to whatever is the default after running. May
  #need to increase if internet is slow and you get download errors but the
  #links are valid.
  ...
  #Variations on the method
  {
    ...
    #be consistent and are missing data from certain facilities.  Emails with
    #the departments suggest CWNS is about need while DMR reports active flow
    #data.
  ...
  #Emission factors, GHGI values, and other sector-specific information
  {
    ...
    #gas is dealt with separately, so not included here.  The desired inventory
    #year (or closest available) should be used.  Res = residential, Com =
    #commercial, Ind = industrial, elec = electric.  Petr = petroleum.
    stationary_combustion_GHGI_data <- data.frame("State"="US_EPA",
                                                  ...
                                                  "com_wood"=84,
                                                  "ind_wood"=1407,
                                                  "elec_wood"=201) #newer GHGI values for 2019
    # stationary_combustion_GHGI_data <- data.frame("State"="US_EPA",
    #                                               "com_coal"=17,
    #                                               "ind_coal"=517,
    #                                               "elec_coal"=10554,
    ...
    #                                               "com_wood"=84,
    #                                               "ind_wood"=1407,
    #                                               "elec_wood"=68) #older GHGI values for 2019
    ...
    #nonseptic is the sum of all other entries in the table.
    ...
    #CH4 Emissions from Septic Systems.  Originates from
