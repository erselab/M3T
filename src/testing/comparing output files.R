...
#were double counted (in both LMOP and GHGRP)
...
# old <- list.files("G:/My Drive/Shepson Group Drive/Kris/Philly Inventory/Processed_rewrite/",pattern="Freshwater.*\\.nc",full.names = T)
