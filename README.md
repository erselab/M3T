...
6.  Wetlands and Inland Waters
    - Wetcharts_NLCD_landcover</b>\_downscaled_subset\_<b>N</b>.nc
...
8.  Combining sectors
    - a separate folder will be created with each unique combination of
      ...
      file. Summary combinations will be saved in a separate folder, as
      will thermogenic/non-thermogenic combinations.
